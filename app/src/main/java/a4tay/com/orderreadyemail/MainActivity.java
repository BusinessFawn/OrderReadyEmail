...
public class MainActivity extends AppCompatActivity {
    ...
    static ArrayList<String> carrier = new ArrayList<>();
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new OrderSection(), "Order List");
        adapter.addFragment(new InputSection(), "Add Order");
        adapter.addFragment(new SettingsSection(), "Settings");
